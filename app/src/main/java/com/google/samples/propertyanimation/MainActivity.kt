...
class MainActivity : AppCompatActivity() {
    ...
    private fun fader() {
        ...
        animator.apply {
            this.duration = 1000
            this.disableViewDuringAnimation(fadeButton)
            this.repeatCount = 1
            this.repeatMode = ObjectAnimator.REVERSE
            this.start()
        }
    ...
    private fun shower() {
        ...
        // Random size from .1x to 1.6x
        newStar.scaleX = Math.random().toFloat() * 1.5f + .1f
        newStar.scaleY = newStar.scaleX
        starW *= newStar.scaleX
        starH *= newStar.scaleY
        // Horizontal position randomly somewhere from the left edge to the right edge
        ...
        // star removed from the container after animation is finished
